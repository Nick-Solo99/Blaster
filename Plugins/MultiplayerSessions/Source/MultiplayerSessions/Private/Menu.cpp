...
void UMenu::MenuSetup(int32 NumberOfPublicConnections, FString TypeOfMatch, FString LobbyPath)
{
	...
	if (MultiplayerSessionsSubsystem)
	{
		...
		MultiplayerSessionsSubsystem->MultiplayerFindSessionsComplete.AddUObject(this, &ThisClass::OnFindSessions);
...
bool UMenu::Initialize()
{
	...
	if (ButtonHost)
	{
		ButtonHost->OnClicked.AddDynamic(this, &UMenu::ButtonHostClicked);
	}
	if (ButtonJoin)
	{
		ButtonJoin->OnClicked.AddDynamic(this, &UMenu::ButtonJoinClicked);
	}
