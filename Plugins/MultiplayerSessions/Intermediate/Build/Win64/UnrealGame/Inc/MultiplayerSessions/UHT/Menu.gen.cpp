...
// Begin Class UMenu Function ButtonHostClicked
struct Z_Construct_UFunction_UMenu_ButtonHostClicked_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMenu_ButtonHostClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMenu, nullptr, "ButtonHostClicked", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_ButtonHostClicked_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMenu_ButtonHostClicked_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UMenu_ButtonHostClicked()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMenu_ButtonHostClicked_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMenu::execButtonHostClicked)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ButtonHostClicked();
	P_NATIVE_END;
}
// End Class UMenu Function ButtonHostClicked

// Begin Class UMenu Function ButtonJoinClicked
struct Z_Construct_UFunction_UMenu_ButtonJoinClicked_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Menu.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMenu_ButtonJoinClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMenu, nullptr, "ButtonJoinClicked", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMenu_ButtonJoinClicked_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMenu_ButtonJoinClicked_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UMenu_ButtonJoinClicked()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMenu_ButtonJoinClicked_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMenu::execButtonJoinClicked)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ButtonJoinClicked();
	P_NATIVE_END;
}
// End Class UMenu Function ButtonJoinClicked
...
struct Z_Construct_UFunction_UMenu_OnCreateSession_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/**\n\x09 * Callbacks for custom delegates on MultiplayerSessionSubsystem\n\x09 */" },
#endif
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Callbacks for custom delegates on MultiplayerSessionSubsystem" },
#endif
	};
#endif // WITH_METADATA
...
void UMenu::StaticRegisterNativesUMenu()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "ButtonHostClicked", &UMenu::execButtonHostClicked },
		{ "ButtonJoinClicked", &UMenu::execButtonJoinClicked },
...
struct Z_Construct_UClass_UMenu_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ButtonHost_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ButtonJoin_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// The Subsystem designed to handle all online session functionality\n" },
#endif
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "The Subsystem designed to handle all online session functionality" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ButtonHost;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ButtonJoin;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MultiplayerSessionsSubsystem;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMenu_ButtonHostClicked, "ButtonHostClicked" }, // 1370389863
		{ &Z_Construct_UFunction_UMenu_ButtonJoinClicked, "ButtonJoinClicked" }, // 3803179669
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3350469954
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 597177597
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMenu_Statics::NewProp_ButtonHost = { "ButtonHost", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMenu, ButtonHost), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ButtonHost_MetaData), NewProp_ButtonHost_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMenu_Statics::NewProp_ButtonJoin = { "ButtonJoin", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMenu, ButtonJoin), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ButtonJoin_MetaData), NewProp_ButtonJoin_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMenu_Statics::NewProp_MultiplayerSessionsSubsystem = { "MultiplayerSessionsSubsystem", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMenu, MultiplayerSessionsSubsystem), Z_Construct_UClass_UMultiplayerSessionsSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MultiplayerSessionsSubsystem_MetaData), NewProp_MultiplayerSessionsSubsystem_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMenu_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMenu_Statics::NewProp_ButtonHost,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMenu_Statics::NewProp_ButtonJoin,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_xGrim_Documents_Udemy_Unreal_Engine_5_C___Multiplayer_Shooter_Projects_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 2498390963U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_xGrim_Documents_Udemy_Unreal_Engine_5_C___Multiplayer_Shooter_Projects_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_779183604(TEXT("/Script/MultiplayerSessions"),
	Z_CompiledInDeferFile_FID_Users_xGrim_Documents_Udemy_Unreal_Engine_5_C___Multiplayer_Shooter_Projects_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_xGrim_Documents_Udemy_Unreal_Engine_5_C___Multiplayer_Shooter_Projects_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
